...
CAMERASLACK_X = 120  # how far from the center the squirrel moves before moving the camera
...
def getBounceAmount(currentBounce, bounceRate, bounceHeight, bounceDir='up'):
