...
CAMERASLACK_X = 90  # how far from the center the squirrel moves before moving the camera
CAMERASLACK_Y = 60  # how far from the center the squirrel moves before moving the camera

# Change for requirement 2:
# MOVERATE = 9         # how fast the player moves
# BOUNCERATE = 6       # how fast the player bounces (large is slower)
MOVERATE = 15  # how fast the player moves
BOUNCERATE = 9  # how fast the player bounces (large is slower)

BOUNCEHEIGHT = 30  # how high the player bounces
STARTSIZE = 25  # how big the player starts off
WINSIZE = 300  # how big the player needs to be to win
# Change for requirement 8:
...
def runGame():
    ...
    while True:  # main game loop
        ...
        flashIsOn = round(time.time(), 1) * 10 % 4 <= 1
            ...
            for i in range(len(squirrelObjs) - 1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size'] ** 2:
                        ...
                        if playerObj['size'] > WINSIZE and not winMode:
                            # Change for requirement 10:
                            winSurf3, winRect3 = makeWinSurf(round(time.time() - gameStartTime))
...
# Change for requirement 10:
def makeWinSurf(winTime):
    winSurf3 = BASICFONT.render('You won in: {} seconds'.format(winTime), True, WHITE)
    winRect3 = winSurf3.get_rect()
    winRect3.center = (HALF_WINWIDTH, HALF_WINHEIGHT + 60)
    return winSurf3, winRect3
